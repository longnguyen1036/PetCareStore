...
const Welcome = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {currentPage === 0 ? <View>{welcome1()}</View> : null}
      {currentPage === 1 ? <View>{welcome2()}</View> : null}
      {currentPage === 2 ? <View>{welcome3()}</View> : null}
      <View style={styles.bacham}>
        {currentPage === 0 ? (
          <Ionicons color={'#18A2E1'} name="radio-button-on" size={10} />
        ) : (
          <Ionicons name="radio-button-off" size={10} />
        )}

        {currentPage === 1 ? (
          <Ionicons name="radio-button-on" color={'#18A2E1'} size={10} />
        ) : (
          <Ionicons name="radio-button-off" size={10} />
        )}
