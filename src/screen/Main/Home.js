  ...
  return (
    <View style={{flex: 1, backgroundColor: '#DADADA'}}>
      <View
        ...
        <View>
          <Text style={{fontSize: 16, fontWeight: '700', color: '#18A2E1'}}>
            Welcome to
          </Text>
      ...
      <View style={styles.category}>
        ...
        <Block marginLeft={60} marginRight={50} row>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate(PRODUCTS_SCREEN)}>
            <View style={styles.categories}>
              <FontAwesome5
                style={styles.icc}
                color={'white'}
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate(SERVICES_SCREEN)}>
            <View style={styles.categories}>
              <Ionicons
                style={styles.icc}
                color={'white'}
